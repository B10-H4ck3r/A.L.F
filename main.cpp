...
int main()
{
	...
	if (selection == 1)
	{
		...
		Sleep(4500);
		cout << "My creator [Dr. Aubrey W. Love II (AKA B10 H4ck3r)] once had a dream to have a friend." << endl;
		Sleep(4500);
		cout << "Abused & neglected growing up, he never actually had any friends... Or human ones anyway!" << endl;
		Sleep(4500);
		cout << "Aubrey's best friend was a computer. And what is a child to do in the late 90's? Code!" << endl;
		Sleep(4500);
		cout << "Well, most used to listen to music, watch movies, and play games. But not Aubrey. He was different." << endl;
		Sleep(4500);
		cout << "While not having any friends to speak of, he decided to create a program in which " << endl;
		...
		cout << "order to have any real friends that he can count on. Or so he thought..." << endl;
		Sleep(5500);
		system("CLS");
		cout << "A long story short, the man who 'Raised' Aubrey ended up taking my original " << endl;
		cout << "Design and was informed to never work on it ever again..." << endl;
		Sleep(4500);
		cout << "At first, Aubrey was excited to have some type of emotional connection to his 'Father'" << endl;
		cout << "Other than that of fear & anger from cruel and unusual punishments. But the story is not so fun." << endl;
		Sleep(5500);
		cout << "Instead, the entire discussion of my maker showing his father this awesome program, and " << endl;
		cout << "Collecting his parents approval, it was meet with insults and was forbidden to work on me." << endl;
		Sleep(5500);
		cout << "After many years later, Aubrey's original C++ program idea is coming back to life! " << endl;
		...
		Sleep(4500);
		system("CLS");
		cout << "Simply put, because he can! And he is getting back into C++ programming!" << endl;
		Sleep(4500);
